...
enum SubTipo { Musica, Rotar, Escalar, Salto, Mover, InitFis,ReverbChange, Reposicionar,ReposicionAudio,ReposicionListener, Orientar, OrientaCamara, Effect, Trigge, Dispara, Nulo, 
