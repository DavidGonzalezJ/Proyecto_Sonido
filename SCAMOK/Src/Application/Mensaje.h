...
enum SubTipo { Musica, Rotar, Escalar, Salto, Mover, InitFis, Reposicionar,ReposicionAudio,ReposicionListener, Orientar, OrientaCamara, Effect, Trigge, Dispara, Nulo, 
